  ...
  var cookieBanner = function cookieBanner() {
    ...
    if (showBanner) {
      ...
      if (preferences) {
        ...
        var preferencesCheckboxes = document.getElementById("cb-preferences-checkboxes");
      ...
      cookiePreferences && onPreferencesSave && onPreferencesSave(cookiePreferences);
    }
  };
